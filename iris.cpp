...
const unsigned int index_length = 50;  // Total number of samples per species

enum{setosa,versicolor,virginica};     // species names

enum{sepal_length,sepal_width,petal_length,petal_width}; // attribute names

const float iris[3][4][index_length] = // 3 species, 4 attributes, 50 samples
{
	{ // setosa
		{ // setosa sepal_length
...
int main() {
	...
	cout << "Value: " << iris[virginica][sepal_length][19] << endl;
